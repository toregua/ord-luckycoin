...
use crate::lky20::deploy::Deploy;
use crate::lky20::errors::JSONError;
use crate::lky20::mint::Mint;
use crate::lky20::params::PROTOCOL_LITERAL;
use crate::lky20::transfer::Transfer;
use crate::lky20::OperationType;
...
pub(crate) fn deserialize_lky20_operation(
  ...
  let raw_operation = match deserialize_lky20(content_body) {
    Ok(op) => op,
    Err(e) => {
      return Err(e.into());
    }
  ...
  match action {
    ...
    Action::Transfer => match raw_operation {
      ...
      _ => Err(JSONError::NotLKY20Json.into()),
    },
  }
}
